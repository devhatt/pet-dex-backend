...
func TestCreateConfigForMailPkg(t *testing.T) {
	...
	assert.Equal(t, cfg.HostAddress, "smtp.gmail.com")
...
func TestErrorOnCreateConfigMissing(t *testing.T) {
	configsParamethers := []struct {
		...
		{EmailAdress: "example@.com", EmailSecretPassword: "secret", Provider: "smtp.gmail.com", HostAddress: "smtp.gmail.com", HostPort: "587", ErrorMessage: "ConfigEmailAddress must be a valid email address"},
		{EmailAdress: "example@gmail.com", EmailSecretPassword: "", Provider: "smtp.gmail.com", HostAddress: "smtp.gmail.com", HostPort: "587", ErrorMessage: "Secret password cannot be empty"},
		{EmailAdress: "example@gmail.com", EmailSecretPassword: "secret", Provider: "", HostAddress: "smtp.gmail.com", HostPort: "587", ErrorMessage: "Provider cannot be empty"},
		...
		{EmailAdress: "example@gmail.com", EmailSecretPassword: "secret", Provider: "smtp.gmail.com", HostAddress: "smtp.gmail.com", HostPort: "", ErrorMessage: "Host port cannot be empty"},
	}
